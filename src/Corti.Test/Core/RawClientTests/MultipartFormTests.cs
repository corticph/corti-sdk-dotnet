...
namespace Corti.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Corti.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Corti.Core.MultipartFormRequest
        {
