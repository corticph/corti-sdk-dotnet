...
public partial interface ICodesClient
{
    ...
    /// </summary>
    WithRawResponseTask<ResponseCodesList> ListCodesAsync(
    ...
    /// </summary>
    WithRawResponseTask<ResponseCodesList> GenerateCodesAsync(
    ...
    /// </summary>
    WithRawResponseTask<ResponseCodesList> SelectCodesAsync(
