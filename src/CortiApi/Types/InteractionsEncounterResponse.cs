...
[Serializable]
public record InteractionsEncounterResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required InteractionsEncounterStatusEnum Status { get; set; }

    /// <summary>
    /// The specific type of encounter, providing context about the nature and setting of the patient interaction.
    /// </summary>
    [JsonPropertyName("type")]
    public required InteractionsEncounterTypeEnum Type { get; set; }

    /// <summary>
    /// The time period during which the encounter takes place.
    /// </summary>
    [JsonPropertyName("period")]
    public required InteractionsEncounterPeriod Period { get; set; }
