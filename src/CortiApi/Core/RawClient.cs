...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::CortiApi.Core.ApiResponse> SendRequestAsync(
        global::CortiApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::CortiApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::CortiApi.Core.ApiResponse
            {
    ...
    private static string BuildUrl(global::CortiApi.Core.BaseRequest request)
    {
