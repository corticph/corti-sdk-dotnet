...
namespace CortiApi.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static CortiApi.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new CortiApi.Core.MultipartFormRequest
        {
