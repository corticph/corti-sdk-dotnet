...
public partial class TasksClient : ITasksClient
{
    ...
    private async Task<WithRawResponse<CommonTaskListResponse>> ListAsyncCore(
        string agentId,
                ...
                var response = await _client
                    .SendRequestAsync(
                        new JsonRequest
                        {
                            ...
                            Method = HttpMethod.Get,
                            Path = string.Format(
                                "v2/agentic/agents/{0}/a2a/tasks/{1}",
                                ValueConvert.ToPathParameterString(agentId),
                ...
                var response = await _client
                    .SendRequestAsync(
                        new JsonRequest
                        {
                            ...
                            Path = string.Format(
                                "v2/agentic/agents/{0}/a2a/tasks/{1}:cancel",
                                ValueConvert.ToPathParameterString(agentId),
                                ValueConvert.ToPathParameterString(taskId)
                            ),
                            Headers = _headers,
    ...
    /// <example><code>
    /// await client.Agentic.A2A.Tasks.ListAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     new Corti.Agentic.A2A.ListTasksRequest { A2AVersion = "1.0" }
    /// );
    /// </code></example>
    public WithRawResponseTask<CommonTaskListResponse> ListAsync(
        string agentId,
        ListTasksRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CommonTaskListResponse>(
            ListAsyncCore(agentId, request, options, cancellationToken)
        );
    }

    /// <example><code>
    /// await client.Agentic.A2A.Tasks.GetAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62",
    ///     new GetTasksRequest { A2AVersion = "1.0" }
    /// );
    /// </code></example>
    ...
    /// <example><code>
    /// await client.Agentic.A2A.Tasks.CancelAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62"
    /// );
    /// </code></example>
