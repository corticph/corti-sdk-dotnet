...
public partial class A2AClient : IA2AClient
{
    ...
    internal A2AClient(RawClient client)
    {
        ...
        {
            _client = client;
            Tasks = new Corti.Agentic.A2A.TasksClient(_client);
        }
        catch (Exception ex)
        {
    ...
    public Corti.Agentic.A2A.ITasksClient Tasks { get; }
                ...
                var response = await _client
                    .SendRequestAsync(
                        new JsonRequest
                        {
                            ...
                            Method = HttpMethod.Post,
                            Path = string.Format(
                                "v2/agentic/agents/{0}/a2a/message:send",
                                ValueConvert.ToPathParameterString(agentId)
                            ),
                            Body = request,
                            Headers = _headers,
                ...
                var response = await _client
                    .SendRequestAsync(
                        new JsonRequest
                        {
                            ...
                            Method = HttpMethod.Post,
                            Path = string.Format(
                                "v2/agentic/agents/{0}/a2a/message:stream",
                                ValueConvert.ToPathParameterString(agentId)
                            ),
                            Body = request,
                            Headers = _headers,
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agentic.A2A.JsonRpcAsync(
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agentic.A2A.SendMessageAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ...
    /// </summary>
    /// <example><code>
    /// client.Agentic.A2A.StreamMessageAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     new A2ASendMessageRequest
    ///     {
    ///         Message = new CommonMessage
