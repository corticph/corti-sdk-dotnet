...
public partial class ContextsClient : IContextsClient
{
    ...
    private async Task<WithRawResponse<ContextsListResponse>> ListAsyncCore(
    ...
    private async Task<WithRawResponse<ContextsTraceResponse>> GetTraceAsyncCore(
        string contextId,
    ...
    /// </code></example>
    public WithRawResponseTask<ContextsListResponse> ListAsync(
        ListContextsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ContextsTraceResponse> GetTraceAsync(
        string contextId,
        GetTraceContextsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ContextsTraceResponse>(
            GetTraceAsyncCore(contextId, request, options, cancellationToken)
        );
    }
}
