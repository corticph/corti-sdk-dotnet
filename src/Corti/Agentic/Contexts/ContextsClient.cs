...
public partial class ContextsClient : IContextsClient
{
    ...
    /// </summary>
    private WithRawResponseTask<ContextsListResponse> ListInternalAsync(
        ListContextsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ContextsListResponse>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<ContextsListResponse>> ListInternalAsyncCore(
        ListContextsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        var responseData = JsonUtils.Deserialize<ContextsListResponse>(
                            responseBody
                        )!;
                        return new WithRawResponse<ContextsListResponse>()
                        {
                            Data = responseData,
    ...
    private async Task<WithRawResponse<ContextsDetailResponse>> GetAsyncCore(
        string contextId,
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        var responseData = JsonUtils.Deserialize<ContextsDetailResponse>(
                            responseBody
                        )!;
                        return new WithRawResponse<ContextsDetailResponse>()
                        {
                            Data = responseData,
                            RawResponse = new Corti.RawResponse()
                            {
    ...
    /// </summary>
    private WithRawResponseTask<ContextsTraceResponse> GetTraceInternalAsync(
        string contextId,
    ...
    {
        return new WithRawResponseTask<ContextsTraceResponse>(
            GetTraceInternalAsyncCore(contextId, request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<ContextsTraceResponse>> GetTraceInternalAsyncCore(
        string contextId,
        GetTraceContextsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        var responseData = JsonUtils.Deserialize<ContextsTraceResponse>(
                            responseBody
                        )!;
                        return new WithRawResponse<ContextsTraceResponse>()
                        {
                            Data = responseData,
                            RawResponse = new Corti.RawResponse()
                            {
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agentic.Contexts.ListAsync(new ListContextsRequest());
    /// </code></example>
    public async Task<Pager<Corti.Contexts>> ListAsync(
        ListContextsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ContextsDetailResponse> GetAsync(
        string contextId,
        GetContextsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<ContextsDetailResponse>(
    ...
    ///     "ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51",
    ///     new GetTraceContextsRequest()
    /// );
    /// </code></example>
    public async Task<Pager<ContextsTraceItem>> GetTraceAsync(
        string contextId,
        GetTraceContextsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
