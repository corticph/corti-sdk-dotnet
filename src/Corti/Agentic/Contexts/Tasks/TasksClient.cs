...
public partial class TasksClient : ITasksClient
{
    ...
    /// <example><code>
    /// await client.Agentic.Contexts.Tasks.ListAsync(
    ///     "ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51",
    ///     new AgenticContextsTasksListRequest()
    /// );
    /// </code></example>
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                var pager = await CursorPager<
                    AgenticContextsTasksListRequest,
                    RequestOptions?,
    ...
    /// <example><code>
    /// await client.Agentic.Contexts.Tasks.GetAsync(
    ///     "ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51",
