...
public partial class FeedbackClient : IFeedbackClient
{
    ...
    private async Task<WithRawResponse<AgenticFeedbackListResponse>> ListAsyncCore(
        string contextId,
        string taskId,
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                var response = await _client
                    .SendRequestAsync(
                        new JsonRequest
                        {
                            ...
                            Path = string.Format(
                                "agentic/contexts/{0}/tasks/{1}/feedback",
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        var responseData = JsonUtils.Deserialize<AgenticFeedbackListResponse>(
                            responseBody
                        )!;
                        return new WithRawResponse<AgenticFeedbackListResponse>()
                        {
                            Data = responseData,
    ...
    private async Task<WithRawResponse<AgenticFeedbackResponse>> CreateAsyncCore(
        string contextId,
        string taskId,
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        var responseData = JsonUtils.Deserialize<AgenticFeedbackResponse>(
                            responseBody
                        )!;
                        return new WithRawResponse<AgenticFeedbackResponse>()
                        {
                            Data = responseData,
                            RawResponse = new Corti.RawResponse()
                            {
                ...
                var response = await _client
                    .SendRequestAsync(
                        new JsonRequest
                        {
                            ...
                            Path = string.Format(
                                "agentic/contexts/{0}/tasks/{1}/feedback/{2}",
                                ValueConvert.ToPathParameterString(contextId),
                                ValueConvert.ToPathParameterString(taskId),
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agentic.Contexts.Tasks.Feedback.ListAsync(
    ///     "ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51",
    ///     "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62"
    /// );
    /// </code></example>
    public WithRawResponseTask<AgenticFeedbackListResponse> ListAsync(
        string contextId,
        string taskId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<AgenticFeedbackListResponse>(
    ...
    ///     {
    ///         Rating = new AgenticFeedbackRating { Scale = AgenticFeedbackRatingScale.Binary, Value = 1 },
    ///     }
    /// );
    /// </code></example>
    public WithRawResponseTask<AgenticFeedbackResponse> CreateAsync(
        string contextId,
        string taskId,
        AgenticFeedbackCreateRequest request,
        RequestOptions? options = null,
    ...
    {
        return new WithRawResponseTask<AgenticFeedbackResponse>(
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agentic.Contexts.Tasks.Feedback.DeleteAsync(
    ///     "ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51",
    ///     "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62",
