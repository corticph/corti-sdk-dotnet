...
public partial class ConnectorsClient : IConnectorsClient
{
    ...
    private async Task<WithRawResponse<ConnectorsListResponse>> ListAsyncCore(
        string agentId,
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                var response = await _client
                    .SendRequestAsync(
                        new JsonRequest
                        {
                            ...
                            Path = string.Format(
                                "v2/agentic/agents/{0}/connectors",
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        var responseData = JsonUtils.Deserialize<ConnectorsListResponse>(
                            responseBody
                        )!;
                        return new WithRawResponse<ConnectorsListResponse>()
                        {
                            Data = responseData,
    ...
    private async Task<WithRawResponse<CommonConnectorResponse>> AttachAsyncCore(
        string agentId,
                ...
                var response = await _client
                    .SendRequestAsync(
                        new JsonRequest
                        {
                            ...
                            Method = HttpMethod.Get,
                            Path = string.Format(
                                "v2/agentic/agents/{0}/connectors/{1}",
                                ValueConvert.ToPathParameterString(agentId),
    ...
    private async Task<RawResponse> RemoveAsyncCore(
        string agentId,
        string agentConnectorId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    /// <example><code>
    /// await client.Agentic.Connectors.ListAsync("agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40");
    /// </code></example>
    public WithRawResponseTask<ConnectorsListResponse> ListAsync(
        string agentId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ConnectorsListResponse>(
            ListAsyncCore(agentId, options, cancellationToken)
        );
    }

    /// <example><code>
    /// await client.Agentic.Connectors.AttachAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     new CommonRegistryConnectorCreate { Name = "@dedalus/coding-expert" }
    /// );
    /// </code></example>
    public WithRawResponseTask<CommonConnectorResponse> AttachAsync(
        string agentId,
        CommonConnectorCreateRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CommonConnectorResponse>(
            AttachAsyncCore(agentId, request, options, cancellationToken)
        );
    }

    /// <example><code>
    /// await client.Agentic.Connectors.GetAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ...
    /// <example><code>
    /// await client.Agentic.Connectors.RemoveAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     "con.0192f4c8-7baf-7083-a46f-81d2bd70cf95"
    /// );
    /// </code></example>
    public WithRawResponseTask RemoveAsync(
        string agentId,
        string agentConnectorId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(
            RemoveAsyncCore(agentId, agentConnectorId, options, cancellationToken)
        );
    }
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agentic.Connectors.UpdateAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     "con.0192f4c8-7baf-7083-a46f-81d2bd70cf95",
    ///     new ConnectorsPatchRequest { Enabled = false }
    /// );
    /// </code></example>
