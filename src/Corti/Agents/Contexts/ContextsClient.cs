...
public partial class ContextsClient : IContextsClient
{
    ...
    internal ContextsClient(RawClient client)
    {
        ...
        {
            _client = client;
            Tasks = new Corti.Agents.Contexts.TasksClient(_client);
        }
        catch (Exception ex)
        {
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agents.Contexts.GetAsync(
    ...
    /// <example><code>
    /// await client.Agents.Contexts.DeleteAsync("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51");
    /// </code></example>
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agents.Contexts.GetTraceAsync(
    ///     "ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51",
