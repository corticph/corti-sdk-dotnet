...
namespace Corti.Agents.Contexts;
...
public partial class TasksClient : ITasksClient
{
    ...
    )
    {
        return new WithRawResponseTask<CommonTaskListResponse>(
            ListInternalAsyncCore(contextId, request, options, cancellationToken)
        );
    }
    ...
    /// <example><code>
    /// await client.Agents.Contexts.Tasks.ListAsync(
    ///     "ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51",
    ///     new Corti.Agents.Contexts.ListTasksRequest()
    /// );
    /// </code></example>
                ...
                >
                    .CreateInstanceAsync(
                        ...
                        async (request, options, cancellationToken) =>
                            await ListInternalAsync(contextId, request, options, cancellationToken)
                                .WithRawResponse(),
                        (request, cursor) =>
                        {
    ...
    /// <example><code>
    /// await client.Agents.Contexts.Tasks.GetAsync(
    ///     "ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51",
    ...
    )
    {
        return new WithRawResponseTask<CommonTaskResponse>(
            GetAsyncCore(contextId, taskId, options, cancellationToken)
        );
    }
}
