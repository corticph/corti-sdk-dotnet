...
public partial class A2AClient : IA2AClient
{
    ...
    internal A2AClient(RawClient client)
    {
        ...
        {
            _client = client;
            Tasks = new Corti.Agents.A2A.TasksClient(_client);
        }
        catch (Exception ex)
        {
    ...
    public Corti.Agents.A2A.ITasksClient Tasks { get; }
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agents.A2A.JsonRpcAsync(
    ...
    /// </summary>
    /// <example><code>
    /// await client.Agents.A2A.SendMessageAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ...
    /// </summary>
    /// <example><code>
    /// client.Agents.A2A.StreamMessageAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     new A2ASendMessageRequest
    ///     {
    ///         Message = new CommonMessage
