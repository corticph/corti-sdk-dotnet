...
public partial class TasksClient : ITasksClient
{
    ...
    /// <example><code>
    /// await client.Agents.A2A.Tasks.ListAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     new Corti.Agents.A2A.ListTasksRequest { A2AVersion = "1.0" }
    /// );
    /// </code></example>
    ...
    /// <example><code>
    /// await client.Agents.A2A.Tasks.GetAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ...
    /// <example><code>
    /// await client.Agents.A2A.Tasks.CancelAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62"
    /// );
    /// </code></example>
    ...
    /// <example><code>
    /// await client.Agents.A2A.Tasks.SubscribeAsync(
    ///     "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
    ///     "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62"
    /// );
    /// </code></example>
