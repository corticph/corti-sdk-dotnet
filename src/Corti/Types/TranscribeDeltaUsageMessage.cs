...
[Serializable]
public record TranscribeDeltaUsageMessage : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public TranscribeDeltaUsageMessage.TypeLiteral Type { get;
    ...
    {
        public const string Value = "delta_usage";
