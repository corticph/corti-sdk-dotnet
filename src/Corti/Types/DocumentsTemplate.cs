...
public class DocumentsTemplate
{
    ...
    /// <summary>
    /// Factory method to create a union from a Corti.DocumentsTemplateWithSections value.
    /// </summary>
    ...
    /// <summary>
    /// Factory method to create a union from a Corti.DocumentsTemplateWithSectionKeys value.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Corti.DocumentsTemplateWithSections"/> and returns true if successful.
    /// </summary>
    public bool TryGetDocumentsTemplateWithSections(out Corti.DocumentsTemplateWithSections? value)
    {
        if (Type == "documentsTemplateWithSections")
        {
            value = (Corti.DocumentsTemplateWithSections)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Corti.DocumentsTemplateWithSectionKeys"/> and returns true if successful.
    /// </summary>
    public bool TryGetDocumentsTemplateWithSectionKeys(
        out Corti.DocumentsTemplateWithSectionKeys? value
    )
    {
        if (Type == "documentsTemplateWithSectionKeys")
        {
            value = (Corti.DocumentsTemplateWithSectionKeys)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    public T Match<T>(
        Func<Corti.DocumentsTemplateWithSections, T> onDocumentsTemplateWithSections,
        Func<Corti.DocumentsTemplateWithSectionKeys, T> onDocumentsTemplateWithSectionKeys
    )
    {
        return Type switch
        {
    ...
    public void Visit(
        Action<Corti.DocumentsTemplateWithSections> onDocumentsTemplateWithSections,
        Action<Corti.DocumentsTemplateWithSectionKeys> onDocumentsTemplateWithSectionKeys
    )
    {
        switch (Type)
        {
    ...
    public static implicit operator DocumentsTemplate(Corti.DocumentsTemplateWithSections value) =>
        new("documentsTemplateWithSections", value);
    ...
    internal sealed class JsonConverter : JsonConverter<DocumentsTemplate>
    {
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.StartObject)
            {
                ...
                {
                    ("documentsTemplateWithSections", typeof(Corti.DocumentsTemplateWithSections)),
                    (
                        "documentsTemplateWithSectionKeys",
                        typeof(Corti.DocumentsTemplateWithSectionKeys)
                    ),
                };
