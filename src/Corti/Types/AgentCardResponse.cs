...
/// </summary>
[Serializable]
public record AgentCardResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required AgentCardResponseCapabilities Capabilities { get; set; }
    ...
    public AgentCardResponseProvider? Provider { get; set; }
    ...
    public IEnumerable<AgentCardResponseSignaturesItem>? Signatures { get; set; }

    /// <summary>
    /// Skills the agent exposes.
    /// </summary>
    [JsonPropertyName("skills")]
    public IEnumerable<AgentCardResponseSkillsItem>? Skills { get; set; }

    /// <summary>
    /// A2A protocol bindings. v2 advertises protocolVersion `1.0` only.
    /// </summary>
    [JsonPropertyName("supportedInterfaces")]
    public IEnumerable<AgentCardResponseSupportedInterfacesItem> SupportedInterfaces { get; set; } =
        new List<AgentCardResponseSupportedInterfacesItem>();
