...
[Serializable]
public record StreamAudioEventMessage : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public StreamAudioEventMessage.TypeLiteral Type { get;
    ...
    public required StreamAudioEventData Data { get; set; }
