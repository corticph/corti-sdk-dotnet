...
[Serializable]
public record TranscribeCommandsUpdateAcceptedMessage : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public TranscribeCommandsUpdateAcceptedMessage.TypeLiteral Type { get;
    ...
    {
        public const string Value = "commands_update_accepted";
