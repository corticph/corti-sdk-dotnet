...
[Serializable]
public record TranscribeAudioEventMessage : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public TranscribeAudioEventMessage.TypeLiteral Type { get;
    ...
    public required TranscribeAudioEventData Data { get; set; }
    ...
    {
        public const string Value = "audioEvent";
