...
[JsonConverter(typeof(AgentsFilePartKind.AgentsFilePartKindSerializer))]
[Serializable]
public readonly record struct AgentsFilePartKind : IStringEnum
{
    ...
    internal class AgentsFilePartKindSerializer : JsonConverter<AgentsFilePartKind>
    {
        ...
        )
        {
            ...
            return new AgentsFilePartKind(stringValue);
        }
