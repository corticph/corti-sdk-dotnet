...
/// </summary>
[Serializable]
public record AgenticFeedbackListResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<AgenticFeedbackResponse> Feedbacks { get; set; } =
        new List<AgenticFeedbackResponse>();
