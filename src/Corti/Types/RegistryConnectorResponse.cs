...
/// </summary>
[Serializable]
public record RegistryConnectorResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<RegistryIcon>? Icons { get; set; }
    ...
    public RegistryConnectorCapabilities? Capabilities { get; set; }
