...
[JsonConverter(typeof(TranscribeErrorMessageType.TranscribeErrorMessageTypeSerializer))]
[Serializable]
public readonly record struct TranscribeErrorMessageType : IStringEnum
{
    ...
    internal class TranscribeErrorMessageTypeSerializer : JsonConverter<TranscribeErrorMessageType>
    {
        public override TranscribeErrorMessageType Read(
        ...
        )
        {
            ...
            return new TranscribeErrorMessageType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            TranscribeErrorMessageType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override TranscribeErrorMessageType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
